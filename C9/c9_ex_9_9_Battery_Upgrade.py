...
class Battery():
    ...
    def upgrade_battery(self):
        """Check the battery size and set capacity to 85."""
        if self.battery_size < 85:
            self.battery_size = 85
        else:
            print ("Battery is ready. You can now go up to 270 miles.")
...
my_bmw = ElectricCar('bmw', 'i5','2020')
